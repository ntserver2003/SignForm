          ...
          <td class="TdFilter"> <table width="100%" border="0" cellpadding="7" cellspacing="3">
			  ...
			  <tr>
                <td>
			            	...
			            	<input type="submit" name="CopyPay" value="Копировать" class="buttonBig" onclick="EditPay_OnClick()">
	  	              <input type="submit" name="Print" value="Печатать" class="buttonBig" onclick="Print_OnClick()">
									<cfelse>
					<cfif CheckAdvanced EQ 0 AND CheckSum EQ '!!!ВНИМАНИЕ - НЕДОСТАТОЧНО СРЕДСТВ!!!' >
			        <cfelse>
	            	<APPLET
	                MAYSCRIPT="MAYSCRIPT" 
	                codebase="../../"  
	                ...
	                <PARAM name="Debug" value="true">
										...
										<input type="submit" name="EditPay" value="Редактировать" class="buttonBig" onclick="EditPay_OnClick()">
	                	<input type="submit" name="Delete" value="Удалить" class="buttonBig" onclick="Delete_OnClick()">
	                	<input type="submit" name="CopyPay" value="Копировать" class="buttonBig" onclick="EditPay_OnClick()">
	                	<input type="submit" name="Print" value="Печатать" class="buttonBig" onclick="Print_OnClick()">
									</cfif>
									</cfcase>
	                	...
	                	<input type="submit" name="Cancel" value="Отменить" class="button" onclick="Mail_OnClick()">
	                	<input type="submit" name="CopyPay" value="Копировать" class="buttonBig" onclick="EditPay_OnClick()">
	                	<input type="submit" name="Print" value="Печатать" class="buttonBig" onclick="Print_OnClick()">
	            		</cfcase>
	            		<cfcase value="Received">
	                	<input type="submit" name="Cancel" value="Отменить" class="buttonBig" onclick="Mail_OnClick()">
	                	<input type="submit" name="CopyPay" value="Копировать" class="buttonBig" onclick="EditPay_OnClick()">
	                	<input type="submit" name="Print" value="Печатать" class="buttonBig" onclick="Print_OnClick()">
	            		</cfcase>
